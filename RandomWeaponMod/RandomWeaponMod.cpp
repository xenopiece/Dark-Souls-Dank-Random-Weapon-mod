...
//			system("pause");
			...
			for (;;) {
				std::cout << "How fast would you like the mod to switch weapons?" << std::endl << "(under 0 makes the code only execute once, 0 makes the game unloadable, its recommended under 10 for fun)" << std::endl << ": ";
				std::cin >> Timer;
				if (!std::cin) {
