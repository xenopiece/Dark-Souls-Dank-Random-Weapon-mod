...
int main()
{
	...
	else
	{
		...
		else
		{
			...
			system("cls");
			if(NIGHTMAREMODESHIELDS) {
				std::cout << "Welcome to the Dark Souls III RandomWeapon Mod by BobRoss" << std::endl << "Timer set to: " << Timer << ", " << "Shields are aviable " << std::endl;
			}
			else
			{
				std::cout << "Welcome to the Dark Souls III RandomWeapon Mod by BobRoss" << std::endl << "Timer set to: " << Timer << ", " << "Shields are not aviable " << std::endl;
			}
